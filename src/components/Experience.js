...
const education = [
  {
    ...
    duration: "2023 - 2025",
    description:
      "Coursework in Machine Learning, Deep Learning, NLP, Cloud Computing, and Data Mining with a focus on end‑to‑end ML systems and production deployment.",
    highlights: ["GPA: 3.8/4.0", "Graduate Teaching/Research Assistant", "Industry-focused projects"]
  },
  {
    degree: "Bachelor of Engineering in Computer Engineering",
    school: "Example Institute of Technology, India",
    duration: "2019 - 2023",
    description:
      "Built strong foundations in algorithms, data structures, databases, and web development while leading multiple technical projects and hackathon teams.",
    highlights: ["Top 10% of class", "Technical club core member", "Multiple coding contest wins"]
  }
];

// Replace this URL with your actual hosted resume PDF
const RESUME_URL = "https://your-domain.com/vedant-resume.pdf"; // or Google Drive preview link [web:92][web:95]
...
return (
  <div className="experience-container">
    <div className="experience-content" data-aos="fade-up">
      ...
      {/* Full-width resume below both columns */}
      <h2 className="experience-title resume-title">Resume</h2>
